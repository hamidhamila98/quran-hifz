...
export default function ArabicTrainingPage({ settings, updateSettings }) {
  ...
  if (sessionEnded) {
    ...
    return (
      <div className={`min-h-screen p-6 ${darkMode ? 'bg-slate-900' : 'bg-gray-50'}`}>
        <div className={`max-w-md mx-auto mt-12 p-8 rounded-2xl ${darkMode ? 'bg-slate-800' : 'bg-white'} shadow-lg text-center`}>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl"
            >
      ...
      {!sessionStarted ? (
        <div className={`max-w-xl mx-auto p-6 rounded-2xl ${darkMode ? 'bg-slate-800' : 'bg-white'} shadow-lg`}>
          ...
          <div className="space-y-6">
            ...
            {/* Coming Soon Notice */}
            <div className={`p-4 rounded-xl border-2 border-dashed ${darkMode ? 'border-amber-700 bg-amber-900/20' : 'border-amber-300 bg-amber-50'}`}>
              <div className="flex items-center gap-3">
                <Brain className={`w-8 h-8 ${darkMode ? 'text-amber-400' : 'text-amber-600'}`} />
                <div>
            ...
            <button
              onClick={startSession}
              disabled={true}
              className="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-medium hover:from-amber-600 hover:to-orange-600 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              <Shuffle className="w-5 h-5" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className={`p-6 rounded-2xl ${darkMode ? 'bg-slate-800' : 'bg-white'} shadow-lg`}>
            <div className="text-center py-12">
              <Brain className={`w-16 h-16 mx-auto mb-4 ${darkMode ? 'text-amber-400' : 'text-amber-500'}`} />
